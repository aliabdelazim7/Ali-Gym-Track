...
const exercisesWithAlts = [
  // Day 1
  {
    ...
    alts: [
      { id: 'd1-e1-main', name: 'Barbell Bench Press', arabicName: 'بنش بريس بالبار المستوي (الأساسي)', equipment: 'بار + دكة مستوية', whyUseIt: 'الخيار الأول لقوة وعضلات الصدر.', githubFolder: 'Barbell_Bench_Press_-_Medium_Grip' },
      ...
      { id: 'd1-e1-alt2', name: 'Chest Dips / Machine Press', arabicName: 'متوازي أو جهاز تجميع الصدر (بديل 2)', equipment: 'جهاز المتوازي أو جهاز الصدر', whyUseIt: 'لو الدكة مشغولة، بيكستهدف الجزء السفلي والمنتصف بقوة.', githubFolder: 'Chest_dip' }
    ]
  },
  {
    ...
    alts: [
      { id: 'd1-e2-main', name: 'Wide-Grip Lat Pulldown', arabicName: 'سحب عالي واسع للجهاز (الأساسي)', equipment: 'جهاز السحب العالي', whyUseIt: 'أفضل تمرين لتعريض مجنص الضهر (V-Taper).', githubFolder: 'Wide-Grip_Lat_Pulldown' },
  ...
  },
  {
    ...
    alts: [
      { id: 'd1-e3-main', name: 'Seated Dumbbell Press', arabicName: 'ضغط كتف بالدمبلز جالساً (الأساسي)', equipment: 'دمبلز + دكة 90 درجة', whyUseIt: 'يحمي الضهر ويعزل كتفك الأمامي والجانبي.', githubFolder: 'Seated_Dumbbell_Press' },
  ...
  },
  {
    ...
    alts: [
      { id: 'd1-e4-main', name: 'Seated Cable Row', arabicName: 'سحب أرضي بالكابل (الأساسي)', equipment: 'جهاز سحب أرضي', whyUseIt: 'يعطي مقاومة مستمرة لكثافة الضهر النصفي.', githubFolder: 'Seated_Cable_Rows' },
      ...
      { id: 'd1-e4-alt2', name: 'T-Bar Row', arabicName: 'سحب تي بار T-Bar (بديل 2)', equipment: 'بار T-Bar أو بار عادي في الزاوية', whyUseIt: 'يسمح بأوزان أثقل لبناء سمك الضهر.', githubFolder: 'T-Bar_Row' }
    ]
  },
  {
    ...
    alts: [
      { id: 'd1-e5-main', name: 'Dumbbell Alternate Curl', arabicName: 'تبادل باي بالدمبلز (الأساسي)', equipment: 'دمبلز', whyUseIt: 'يسمح بتدوير الساعد (Supination) لتكبير الباي.', githubFolder: 'Dumbbell_Alternate_Bicep_Curl' },
  ...
  },
  {
    ...
    alts: [
      { id: 'd1-e6-main', name: 'Cable Rope Pushdown', arabicName: 'ترايسبس بالحبل على الكابل (الأساسي)', equipment: 'كابل + حبل', whyUseIt: 'يعزل الرأس الجانبية للترايسبس بامتياز.', githubFolder: 'Triceps_Pushdown' },
  ...
  },
  {
    ...
    alts: [
      { id: 'd1-e7-main', name: 'Standard Elbow Plank', arabicName: 'بلانك ثبات على الكوع (الأساسي)', equipment: 'مات أرضي', whyUseIt: 'يقوي عضلات البطن العميقة واستقرار الحوض.', githubFolder: 'Plank' },
  ...
  // Day 2
  {
    ...
    alts: [
      { id: 'd2-e1-main', name: 'Barbell Back Squat', arabicName: 'سكوات خلفي بالبار (الأساسي)', equipment: 'بار + راك السكوات', whyUseIt: 'التمرين الأول لبناء قوة وحجم الرجلين والجذع.', githubFolder: 'Barbell_Full_Squat' },
  ...
  },
  {
    ...
    alts: [
      { id: 'd2-e2-main', name: 'Barbell RDL', arabicName: 'ديدليفت روماني بالبار (الأساسي)', equipment: 'بار مستقيم', whyUseIt: 'يبني قوة التسديد في الكورة وعضلات الخلفيات بالجسم.', githubFolder: 'Stiff-Legged_Barbell_Deadlift' },
  ...
  },
  {
    ...
    alts: [
      { id: 'd2-e3-main', name: 'Machine Leg Extension', arabicName: 'جهاز أمامي رجل (الأساسي)', equipment: 'جهاز الأماميات', whyUseIt: 'يعزل العضلة الرباعية الأمامية (Quads) بنسبة 100%.', githubFolder: 'Leg_Extensions' },
  ...
  },
  {
    ...
    alts: [
      { id: 'd2-e4-main', name: 'Standing Calf Raise', arabicName: 'سمانة واقفاً (الأساسي)', equipment: 'جهاز السمانة / استيب', whyUseIt: 'تستهدف العضلة التوأمية السطحية (Gastrocnemius).', githubFolder: 'Standing_Calf_Raises' },
  ...
  },
  {
    ...
    alts: [
      { id: 'd2-e5-main', name: 'Jumping Jacks / Sprint', arabicName: 'سبرينت مشاية أو نط جاق (الأساسي)', equipment: 'مشاية / مساحة حرة', whyUseIt: 'يعود الرئة والجهاز العصبي على السبرينت المتقطع.', githubFolder: 'Jumping_jack' },
  ...
  // Day 4
  {
    ...
    alts: [
      { id: 'd4-e1-main', name: 'Incline Dumbbell Press', arabicName: 'تجميع صدر عالي بالدمبلز (الأساسي)', equipment: 'دمبلز + دكة مائلة 30 درجة', whyUseIt: 'أفضل تمرين لملء وتكبير الصدر العالي.', githubFolder: 'Incline_Dumbbell_Press' },
  ...
  },
  {
    ...
    alts: [
      { id: 'd4-e2-main', name: 'One-Arm Dumbbell Row', arabicName: 'منشار بالدمبل إيد واحدة (الأساسي)', equipment: 'دمبل + دكة', whyUseIt: 'مدى حركي كبير وتركيز فردي على كل جهة.', githubFolder: 'One-Arm_Dumbbell_Row' },
  ...
  },
  {
    ...
    alts: [
      { id: 'd4-e3-main', name: 'Dumbbell Lateral Raise', arabicName: 'رفرفة جانبي بالدمبلز واقفا (الأساسي)', equipment: 'دمبلز', whyUseIt: 'يعطي شكل شكل الكتف الكروي العريض (3D Shoulder).', githubFolder: 'Side_Lateral_Raise' },
  ...
  },
  {
    ...
    alts: [
      { id: 'd4-e4-main', name: 'Cable Face Pulls', arabicName: 'فيس بول بالحبل على الكابل (الأساسي)', equipment: 'كابل عالي + حبل', whyUseIt: 'يحسن صحة مفصل الكتف ويستهدف الكتف الخلفي.', githubFolder: 'Face_Pull' },
  ...
  },
  {
    ...
    alts: [
      { id: 'd4-e5-main', name: 'Hanging Leg Raise', arabicName: 'بطن سفلي متعلق بالعقلة (الأساسي)', equipment: 'بار عقلة', whyUseIt: 'يستهدف عضلات البطن السفلى ويزيد قوة القبضة.', githubFolder: 'Hanging_Leg_Raise' },
  ...
  },
  {
    ...
    alts: [
      { id: 'd4-e6-main', name: 'Russian Twist', arabicName: 'رشان تويست بالطارة أو الدمبل (الأساسي)', equipment: 'طارة / دمبل', whyUseIt: 'يقوي عضلات البطن الجانبية والدوران الميداني في الكورة.', githubFolder: 'Russian_Twist' },
  ...
  // Day 5
  {
    ...
    alts: [
      { id: 'd5-e1-main', name: 'Bulgarian Split Squats', arabicName: 'سكوات بلغاري بالدمبلز (الأساسي)', equipment: 'دمبلز + دكة خلفية', whyUseIt: 'أفضل تمرين لبناء ثبات الركبة والقوة المنفردة للاعبي الكورة.', githubFolder: 'Dumbbell_Lunges' },
  ...
  },
  {
    ...
    alts: [
      { id: 'd5-e2-main', name: 'Seated / Lying Leg Curl', arabicName: 'جهاز خلفيات رجل جالس/مستلقي (الأساسي)', equipment: 'جهاز الخلفيات', whyUseIt: 'يعزل عضلات الهامسترينج الخلفية لحمايتها من التمزق.', githubFolder: 'Seated_Leg_Curl' },
  ...
  },
  {
    ...
    alts: [
      { id: 'd5-e3-main', name: 'Leg Press Machine', arabicName: 'جهاز مكبس الرجلين Leg Press (الأساسي)', equipment: 'جهاز مكبس 45', whyUseIt: 'يسمح بأوزان ضخمة جداً في أمان تام.', githubFolder: 'Leg_Press' },
  ...
  },
  {
    ...
    alts: [
      { id: 'd5-e4-main', name: 'Incline Treadmill Walk', arabicName: 'مشي بميل على المشاية Incline (الأساسي)', equipment: 'مشاية كهربائية', whyUseIt: 'يحرق الدهون بدقة دون التحميل على مفاصل الركبة.', githubFolder: 'Treadmill_walking' },
      ...
      { id: 'd5-e4-alt2', name: 'Stationary Bike', arabicName: 'عجلة الجيم الثابتة (بديل 2)', equipment: 'عجلة جيم', whyUseIt: 'تنشيط الدورة الدموية والاستشفاء العضلي للرجلين.', githubFolder: 'Treadmill_walking' }
    ]
  }
];
...
async function run() {
  console.log('Downloading 100% OFFLINE motion frames for all primary & alternative exercises...');
  let totalSaved = 0;
    ...
    for (const alt of ex.alts) {
      for (let frame = 0; frame <= 1; frame++) {
        ...
        if (!fs.existsSync(filePath) || fs.statSync(filePath).size < 1000) {
          const url = `https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/${alt.githubFolder}/${frame}.jpg`;
          try {
            await download(url, filePath);
            console.log(`✓ Downloaded ${fileName} (${alt.arabicName})`);
            totalSaved++;
          } catch (err) {
  ...
  console.log(`Finished processing all alternative exercise motion files! Total downloaded: ${totalSaved}`);
}
